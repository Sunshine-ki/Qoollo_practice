...
namespace client.Controllers
{
	public class HomeController : Controller
	{
		...
		{
			if (HttpContext.Request.Cookies.ContainsKey("id_5010"))
			{
		...
		public IActionResult Welcome()
		{
			...
			string id = HttpContext.Request.Cookies["id_5010"];
			string data = "";
		...
		public void LoginWithQoollo()
		{
			...
			string redirect_uri = "localhost:5010/Home/AuthOk";
			...
			// Response.Redirect("http://localhost:5004/Home/Auth/?redirect_uri=localhost:5010/Home/GetCode&auth=code&data=photo&who=mysite");
		}
		...
		public RedirectToActionResult AuthOk(string code)
		{
			...
			HttpContext.Response.Cookies.Append("id_5010", id);
